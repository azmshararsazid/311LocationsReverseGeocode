...
# Update these values for your files.
INPUT_CSV = r"311HL.csv"
OUTPUT_CSV = r"311Solvedv2.csv"
...
def main():
    hl = pd.read_csv(INPUT_CSV, encoding=INPUT_ENCODING)
    print(f"Loaded {len(hl)} rows from {INPUT_CSV}")
